...
export const themeMap = {
  ...
  [THEME_ALPEN]: {
    ...
    [CUSTOM_THROBBER_CONNECT]: '#5b2bca'
  },
  [THEME_ALPEN_DARK]: {
    [CUSTOM_BG]: '#2d245b',
    ...
    [CUSTOM_BG_FRAME]: '#291d4f', // NOTE: not applied
    [CUSTOM_BG_HOVER]: '#40376b',
    [CUSTOM_BG_HOVER_SHADOW]: '#e8e0ff1a',
    [CUSTOM_BG_SELECT]: '#3c1f7b',
    [CUSTOM_BG_SELECT_HOVER]: '#4d3288',
    [CUSTOM_BORDER_ACTIVE]: '#ac70ff',
    ...
    [CUSTOM_THROBBER_CONNECT]: '#ac70ff'
  },
  [THEME_DARK]: {
    [CUSTOM_BG]: '#1c1b22',
    [CUSTOM_BG_ACTIVE]: '#6a6a78b3',
    [CUSTOM_BG_DISCARDED]: '#1c1b22',
    [CUSTOM_BG_FIELD]: '#0000004d',
    [CUSTOM_BG_FIELD_ACTIVE]: '#42414d',
    [CUSTOM_BG_FRAME]: '#1c1b22',
    [CUSTOM_BG_HOVER]: '#323138',
    [CUSTOM_BG_HOVER_SHADOW]: '#f9f9fa1a',
    [CUSTOM_BG_SELECT]: '#6a6a78b3',
    [CUSTOM_BG_SELECT_HOVER]: '#7e7e8aba',
    [CUSTOM_BORDER_ACTIVE]: '#323138', // NOTE: 'transparent',
    [CUSTOM_BORDER_FIELD]: '#1c1b22', // NOTE: 'transparent',
    [CUSTOM_BORDER_FIELD_ACTIVE]: '#00ddff',
    [CUSTOM_COLOR]: '#f9f9fa',
    [CUSTOM_COLOR_ACTIVE]: '#ffffff',
    ...
    [CUSTOM_THROBBER_CONNECT]: '#00ddff'
  },
  [THEME_LIGHT]: {
    [CUSTOM_BG]: '#eaeaed',
    [CUSTOM_BG_ACTIVE]: '#ffffff',
    [CUSTOM_BG_DISCARDED]: '#eaeaed',
    [CUSTOM_BG_FIELD]: '#0000000d',
    [CUSTOM_BG_FIELD_ACTIVE]: '#ffffff',
    [CUSTOM_BG_FRAME]: '#eaeaed',
    [CUSTOM_BG_HOVER]: '#d5d5d8',
    [CUSTOM_BG_HOVER_SHADOW]: '#15141a1a',
    [CUSTOM_BG_SELECT]: '#ffffff',
    [CUSTOM_BG_SELECT_HOVER]: '#e8e8e8',
    [CUSTOM_BORDER_ACTIVE]: '#d5d5d8', // NOTE: 'transparent',
    [CUSTOM_BORDER_FIELD]: '#eaeaed', // NOTE: 'transparent',
    ...
    [CUSTOM_THROBBER_CONNECT]: '#0061e0'
  }
};
...
export const getCurrentThemeBaseValues = async (opt = {}) => {
  ...
  // override CUSTOM_THROBBER_CONNECT color
  if (currentThemeColors.has('button_primary') ||
      currentThemeColors.has('focus_outline')) {
    let value = currentThemeColors.get('button_primary') ||
                currentThemeColors.get('focus_outline');
    if (/currentcolor/i.test(value)) {
      value = value.replace(/currentcolor/i, values.get(CUSTOM_COLOR));
    }
    value = getColorInHex(value);
    if (value) {
      values.set(CUSTOM_THROBBER_CONNECT, value);
    }
  }
