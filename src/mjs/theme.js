...
export const themeMap = {
  [CSS_ID]: {
    ...
    [CUSTOM_COLOR_2ND]: CSS_VAR_COLOR_2ND,
    [CUSTOM_COLOR_2ND_ACTIVE]: CSS_VAR_COLOR_2ND_ACTIVE,
  ...
  [THEME_LIGHT]: {
    ...
    [CUSTOM_COLOR]: "#0c0c0d",
    [CUSTOM_COLOR_2ND]: "#737373",
    [CUSTOM_COLOR_2ND_ACTIVE]: "#737373",
  ...
  [THEME_DARK]: {
    ...
    [CUSTOM_BORDER_ACTIVE]: "#cccccc",
    [CUSTOM_COLOR]: "#ffffff",
    [CUSTOM_COLOR_2ND]: "#f9f9fa",
    [CUSTOM_COLOR_2ND_ACTIVE]: "#f9f9fa",
  ...
  for (const key of items) {
    switch (key) {
      ...
      case CUSTOM_COLOR_2ND_ACTIVE: {
        const valueA = currentThemeColors.get("icons");
        if (valueA) {
          values[key] = valueA;
        } else {
          values[key] = baseValues[key];
