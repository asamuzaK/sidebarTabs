...
export const themeMap = {
  ...
  [THEME_DARK]: {
    [CUSTOM_BG]: '#38383d',
    [CUSTOM_BG_ACTIVE]: '#52525e',
    [CUSTOM_BG_DISCARDED]: '#38383d',
    [CUSTOM_BG_FIELD]: '#4a4a55',
    [CUSTOM_BG_FIELD_ACTIVE]: '#000000',
    [CUSTOM_BG_FRAME]: '#1c1b22',
    [CUSTOM_BG_HOVER]: '#4c4c50',
    [CUSTOM_BG_HOVER_SHADOW]: '#f9f9fa1a',
    [CUSTOM_BG_SELECT]: '#52525e',
    [CUSTOM_BG_SELECT_HOVER]: '#63636e',
  ...
  [THEME_LIGHT]: {
    [CUSTOM_BG]: '#ededf1',
    [CUSTOM_BG_ACTIVE]: '#ffffff',
    [CUSTOM_BG_DISCARDED]: '#ededf1',
    [CUSTOM_BG_FIELD]: '#f9f9fb',
    [CUSTOM_BG_FIELD_ACTIVE]: '#ffffff',
    [CUSTOM_BG_FRAME]: '#ededf1',
    [CUSTOM_BG_HOVER]: '#d7d7db',
    [CUSTOM_BG_HOVER_SHADOW]: '#15141a1a',
    [CUSTOM_BG_SELECT]: '#ffffff',
    [CUSTOM_BG_SELECT_HOVER]: '#e7e7e8',
    [CUSTOM_BORDER_ACTIVE]: '#d7d7db', // NOTE: 'transparent',
    [CUSTOM_BORDER_FIELD]: '#ededf1', // NOTE: 'transparent',
