...
import {
  ...
  TAB_MUTE, TAB_OBSERVE, TAB_PIN, TAB_QUERY, TAB_RELOAD, TABS_BOOKMARK,
  TABS_CLOSE, TABS_CLOSE_OTHER, TABS_DUPE, TABS_MOVE_END, TABS_MOVE_START,
  TABS_MOVE_WIN, TABS_MUTE, TABS_PIN, TABS_RELOAD, THEME_DARK, THEME_LIGHT,
  THEME_TAB_COMPACT,
  ...
  describe("handle event", () => {
    ...
    it("should call function", async () => {
      ...
      assert.strictEqual(browser.menus.update.callCount, j + 36,
                         "called update");
      assert.strictEqual(res.length, 36, "result");
      browser.tabs.get.flush();
      browser.menus.update.flush();
    });
