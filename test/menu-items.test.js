...
describe('menu items', () => {
  ...
  describe('should get string and object', () => {
    const itemKeys = [
      ...
      TAB_REOPEN_CONTAINER, TABS_REOPEN_CONTAINER, TAB_MOVE, TABS_MOVE,
  ...
  describe('sub items', () => {
    ...
    const subItemKeys = [
      ...
      TAB_GROUP_BOOKMARK, TAB_GROUP_SELECT, TAB_GROUP_SELECTED,
      TAB_GROUP_CONTAINER, TAB_GROUP_DOMAIN, TAB_GROUP_DETACH,
      TAB_GROUP_DETACH_TABS, TAB_GROUP_UNGROUP, 'sepTabGroup-3',
      TAB_GROUP_CLOSE,
