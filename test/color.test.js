...
describe('color', () => {
  ...
  describe('validate color components', () => {
    ...
    it('should throw', () => {
      assert.throws(() => func([0, 128, 256, 1], { maxRange: 255 }),
        RangeError, '256 is not between 0 and 255.');
    });

    it('should throw', () => {
      assert.throws(() => func([0, -128, 192, 1], { maxRange: 255 }),
        RangeError, '-128 is not between 0 and 255.');
    });
    ...
    it('should throw', () => {
      assert.throws(() => func([0, 128, 192, 1], { minLength: NaN }),
        TypeError, 'NaN is not a number.');
    });

    it('should throw', () => {
      assert.throws(() => func([0, 128, 192, 1], { maxLength: null }),
        TypeError, 'Expected Number but got Null.');
    });

    it('should throw', () => {
      assert.throws(() => func([0, 128, 192, 1], { maxLength: NaN }),
        TypeError, 'NaN is not a number.');
    });

    it('should throw', () => {
      assert.throws(() => func([0, 128, 192, 1], { minRange: null }),
        TypeError, 'Expected Number but got Null.');
    });

    it('should throw', () => {
      assert.throws(() => func([0, 128, 192, 1], { minRange: NaN }),
        TypeError, 'NaN is not a number.');
    });

    it('should throw', () => {
      assert.throws(() => func([0, 128, 192, 1], { maxRange: null }),
        TypeError, 'Expected Number but got Null.');
    });

    it('should throw', () => {
      assert.throws(() => func([0, 128, 192, 1], { maxRange: NaN }),
        TypeError, 'NaN is not a number.');
    });
  ...
  describe('transform matrix', () => {
    ...
    it('should throw', () => {
      assert.throws(() => func([[1, 0, 0], [0, 1, 0], [0, 0, 1]]),
        TypeError, 'Expected Array but got Undefined.');
    });

    it('should throw', () => {
      assert.throws(() => func([[1, 0, 0], [0, 1, 0], [0, 0, 1]], []),
        Error, 'Expected array length of 3 but got 0.');
    });
  ...
  describe('number to hex string', () => {
    ...
    it('should throw', () => {
      assert.throws(() => func(Number.NaN), TypeError,
        'NaN is not a number.');
    });
    ...
    it('should throw', () => {
      assert.throws(() => func(-0.6), RangeError,
        '-1 is not between 0 and 255.');
    });
  ...
  describe('rgb to linear rgb', () => {
    ...
    it('should get value', () => {
      const res = func([0.0405, 0.0405, 0.0405]);
    ...
    it('should get value', () => {
      const res = func([0.0406, 0.0406, 0.0406]);
      res[0] = parseFloat(res[0].toFixed(5));
      res[1] = parseFloat(res[1].toFixed(5));
      res[2] = parseFloat(res[2].toFixed(5));
  ...
  describe('linear rgb to rgb', () => {
    ...
    it('should get value', () => {
      const res = func([0.00313, 0.00313, 0.00313]);
    ...
    it('should get value', () => {
      const res = func([0.00314, 0.00314, 0.00314]);
      res[0] = parseFloat(res[0].toFixed(4));
      res[1] = parseFloat(res[1].toFixed(4));
      res[2] = parseFloat(res[2].toFixed(4));
  ...
  describe('rgb to xyz', () => {
    ...
    it('should throw', () => {
      assert.throws(() => func([NaN, 1, 1]), TypeError,
        'NaN is not a number.');
    });
  ...
  describe('xyz to hsl', () => {
    ...
    it('should get value', () => {
      const xyz = mjs.hexToXyz('#000000');
      const res = func(xyz);
      assert.deepEqual(res, ['none', 'none', 0, 1], 'result');
    });

    it('should get value', () => {
      const xyz = mjs.hexToXyz('#808080');
      const res = func(xyz);
      res[2] = Math.round(res[2]);
    ...
    it('should get value', () => {
      const xyz = mjs.hexToXyz('#12345666');
      const res = func(xyz);
      res[0] = Math.round(res[0]);
      res[1] = Math.round(res[1]);
      res[2] = Math.round(res[2]);
  ...
  describe('xyz-d50 to lab', () => {
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('#008000', true);
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(3));
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('#000000', true);
      const res = func(xyz);
      assert.deepEqual(res, [0, 'none', 'none', 1], 'result');
    });

    it('should get value', () => {
      const xyz = mjs.parseColor('#ffffff', true);
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(5));
    ...
    it('should get value', () => {
      const xyz =
        mjs.parseColor('rgb(75.6208% 30.4487% 47.5634%)', true);
      const res = func(xyz);
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('rgb(10.751% 75.558% 66.398%)', true);
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(2));
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('rgb(76.6254% 66.3607% 5.5775%)', true);
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(2));
      res[1] = parseFloat(res[1].toFixed(2));
      res[2] = parseFloat(res[2].toFixed(2));
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('rgb(12.8128% 53.105% 92.7645%)', true);
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(2));
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('rgb(12.8128% 53.105% 92.7645% / 0.4)', {
        alpha: true
      });
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(2));
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('#7654cd', {
        alpha: true
      });
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(2));
  ...
  describe('xyz-d50 to lch', () => {
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('#808080', true);
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(4));
      res[1] = parseFloat(res[1].toFixed(4));
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('#010101', true);
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(3));
      res[1] = parseFloat(res[1].toFixed(3));
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('#fefefe', true);
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(4));
      res[1] = parseFloat(res[1].toFixed(4));
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('rgb(75.6208% 30.4487% 47.5634%)', true);
      const res = func(xyz);
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('rgb(10.7906% 75.5567% 66.3982%)', true);
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(0));
      res[1] = parseFloat(res[1].toFixed(0));
      res[2] = parseFloat(res[2].toFixed(0));
    ...
    it('should get value', () => {
      const xyz =
        mjs.parseColor('rgb(76.6254% 66.3607% 5.5775%)', true);
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(0));
      res[1] = parseFloat(res[1].toFixed(0));
      res[2] = parseFloat(res[2].toFixed(0));
    ...
    it('should get value', () => {
      const xyz =
        mjs.parseColor('rgb(12.8128% 53.105% 92.7645%)', true);
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(0));
      res[1] = parseFloat(res[1].toFixed(0));
      res[2] = parseFloat(res[2].toFixed(0));
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('#7654cd', true);
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(3));
      res[1] = parseFloat(res[1].toFixed(3));
      res[2] = parseFloat(res[2].toFixed(3));
  ...
  describe('xyz to oklab', () => {
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('rgb(48.477% 34.29% 38.412%)');
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(5));
      res[1] = parseFloat(res[1].toFixed(5));
      res[2] = parseFloat(res[2].toFixed(5));
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('rgb(29.264% 70.096% 63.017%)');
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(5));
      res[1] = parseFloat(res[1].toFixed(5));
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('rgb(73.942% 60.484% 19.65%)');
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(5));
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('rgb(27.888% 38.072% 89.414%)');
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(5));
      res[1] = Math.abs(parseFloat(res[1].toFixed(5)));
      res[2] = parseFloat(res[2].toFixed(5));
  ...
  describe('xyz to oklch', () => {
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('#008000');
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(2));
      res[1] = parseFloat(res[1].toFixed(2));
      res[2] = parseFloat(res[2].toFixed(4));
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('#000000');
      const res = func(xyz);
      assert.deepEqual(res, [0, 'none', 'none', 1], 'result');
    });

    it('should get value', () => {
      const xyz = mjs.parseColor('#ffffff');
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(4));
      assert.deepEqual(res, [1, 'none', 'none', 1], 'result');
    });
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('#808080');
      const res = func(xyz);
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('rgb(70.492% 2.351% 37.073%)');
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(5));
      res[1] = parseFloat(res[1].toFixed(5));
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('rgb(23.056% 31.73% 82.628%)');
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(5));
      res[1] = parseFloat(res[1].toFixed(5));
      res[2] = parseFloat(Math.round(res[2]));
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('rgb(32.022% 85.805% 61.147%)');
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(5));
      res[1] = parseFloat(res[1].toFixed(5));
      res[2] = parseFloat(Math.round(res[2]));
    ...
    it('should get value', () => {
      const xyz = mjs.parseColor('rgb(67.293% 27.791% 52.28%)');
      const res = func(xyz);
      res[0] = parseFloat(res[0].toFixed(5));
      res[1] = parseFloat(res[1].toFixed(5));
      res[2] = parseFloat(Math.round(res[2]));
  ...
  describe('parse lab()', () => {
    ...
    it('should get value', () => {
      ...
      const val = mjs.hexToXyzD50('#008000');
      res[0] = parseFloat(res[0].toFixed(2));
      res[1] = parseFloat(res[1].toFixed(2));
      res[2] = parseFloat(res[2].toFixed(2));
    ...
    it('should get value', () => {
      ...
      const val = mjs.hexToXyzD50('#000000');
      res[0] = parseFloat(res[0].toFixed(2));
      res[1] = parseFloat(res[1].toFixed(2));
      res[2] = parseFloat(res[2].toFixed(2));
      val[0] = parseFloat(val[0].toFixed(2));
    ...
    it('should get value', () => {
      ...
      const val = mjs.hexToXyzD50('#ffffff');
      res[0] = parseFloat(res[0].toFixed(2));
      res[1] = parseFloat(res[1].toFixed(2));
      res[2] = parseFloat(res[2].toFixed(2));
      val[0] = parseFloat(val[0].toFixed(2));
    ...
    it('should get value', () => {
      ...
      const hex = mjs.convertColorToHex('rgb(75.6208% 30.4487% 47.5634%)');
      const val = mjs.hexToXyzD50(hex);
      res[0] = parseFloat(res[0].toFixed(2));
      res[1] = parseFloat(res[1].toFixed(2));
      res[2] = parseFloat(res[2].toFixed(2));
      val[0] = parseFloat(val[0].toFixed(2));
    ...
    it('should get value', () => {
      ...
      const hex = mjs.convertColorToHex('rgb(10.751% 75.558% 66.398%)');
      const val = mjs.hexToXyzD50(hex);
      res[0] = parseFloat(res[0].toFixed(2));
      res[1] = parseFloat(res[1].toFixed(2));
      res[2] = parseFloat(res[2].toFixed(2));
    ...
    it('should get value', () => {
      ...
      const hex = mjs.convertColorToHex('rgb(76.6254% 66.3607% 5.5775%)');
      const val = mjs.hexToXyzD50(hex);
      res[0] = parseFloat(res[0].toFixed(2));
      res[1] = parseFloat(res[1].toFixed(2));
      res[2] = parseFloat(res[2].toFixed(2));
    ...
    it('should get value', () => {
      ...
      const hex = mjs.convertColorToHex('rgb(12.8128% 53.105% 92.7645%)');
      const val = mjs.hexToXyzD50(hex);
      res[0] = parseFloat(res[0].toFixed(2));
      res[1] = parseFloat(res[1].toFixed(2));
      res[2] = parseFloat(res[2].toFixed(2));
    ...
    it('should get value', () => {
      ...
      const val = mjs.hexToXyzD50('#7654cd');
      res[0] = parseFloat(res[0].toFixed(2));
      res[1] = parseFloat(res[1].toFixed(2));
      res[2] = parseFloat(res[2].toFixed(2));
      val[0] = parseFloat(val[0].toFixed(2));
    ...
    it('should get value', () => {
      ...
      const val = mjs.hexToXyzD50('#7654cd80');
      res[0] = parseFloat(res[0].toFixed(2));
      res[1] = parseFloat(res[1].toFixed(2));
      res[2] = parseFloat(res[2].toFixed(2));
    ...
    it('should get value', () => {
      const res = func('lab(44.36 36.05 -59 / -50%)');
      const val = mjs.hexToXyzD50('#7654cd00');
      res[0] = parseFloat(res[0].toFixed(2));
      res[1] = parseFloat(res[1].toFixed(2));
      res[2] = parseFloat(res[2].toFixed(2));
      res[3] = parseFloat(res[3].toFixed(2));
    ...
    it('should get value', () => {
      ...
      const val = mjs.hexToXyzD50('#7654cdff');
      res[0] = parseFloat(res[0].toFixed(2));
      res[1] = parseFloat(res[1].toFixed(2));
      res[2] = parseFloat(res[2].toFixed(2));
      res[3] = parseFloat(res[3].toFixed(2));
    ...
    it('should get value', () => {
      ...
      const val = mjs.hexToXyzD50('#4c0000');
    ...
    it('should get value', () => {
      ...
      const val = mjs.hexToXyzD50('#4b0000');
      res[0] = parseFloat(Math.round(res[0]));
      res[1] = parseFloat(Math.round(res[1]));
      res[2] = parseFloat(Math.round(res[2]));
      val[0] = parseFloat(Math.round(val[0]));
    ...
    it('should get value', () => {
      ...
      const val = mjs.hexToXyzD50('#d13a79');
      res[0] = parseFloat(res[0].toFixed(2));
      res[1] = parseFloat(res[1].toFixed(2));
      res[2] = parseFloat(res[2].toFixed(2));
      val[0] = parseFloat(val[0].toFixed(2));
    ...
    it('should get value', () => {
      ...
      const val = mjs.hexToXyzD50('#8a7500');
      res[0] = parseFloat(Math.round(res[0]));
      res[1] = parseFloat(Math.round(res[1]));
      res[2] = parseFloat(Math.round(res[2]));
      val[0] = parseFloat(Math.round(val[0]));
  ...
  describe('parse lch()', () => {
    ...
    it('should get value', () => {
      ...
      const hex = mjs.convertColorToHex('rgb(10.7906% 75.5567% 66.3982%)');
      const val = mjs.hexToXyzD50(hex);
      res[0] = parseFloat(res[0].toFixed(3));
      res[1] = parseFloat(res[1].toFixed(2));
      res[2] = parseFloat(res[2].toFixed(2));
    ...
    it('should get value', () => {
      ...
      const val = mjs.hexToXyzD50('#230000');
      res[0] = parseFloat(res[0].toFixed(1));
      res[1] = parseFloat(Math.round(res[1]));
      res[2] = parseFloat(Math.round(res[2]));
      val[0] = parseFloat(val[0].toFixed(1));
    ...
    it('should get value', () => {
      ...
      const val = mjs.hexToXyzD50('#220000');
      res[0] = parseFloat(res[0].toFixed(0));
      res[1] = parseFloat(res[1].toFixed(0));
      res[2] = parseFloat(Math.round(res[2]));
    ...
    it('should get value', () => {
      ...
      const val = mjs.hexToXyzD50('#1c1b1b');
      res[0] = parseFloat(res[0].toFixed(1));
      res[1] = parseFloat(res[1].toFixed(3));
      res[2] = parseFloat(res[2].toFixed(3));
      res[3] = parseFloat(res[3].toFixed(1));
    ...
    it('should get value', () => {
      const res = func('lch(10% 20% 30)');
      const val = mjs.hexToXyzD50('#3c0602');
      res[0] = parseFloat(res[0].toFixed(1));
      res[1] = parseFloat(res[1].toFixed(3));
      res[2] = parseFloat(res[2].toFixed(3));
      res[3] = parseFloat(res[3].toFixed(1));
    ...
    it('should get value', () => {
      const res = func('lch(10% 20 -30)');
      const val = mjs.hexToXyzD50('#2d1129');
      res[0] = parseFloat(res[0].toFixed(1));
      res[1] = parseFloat(res[1].toFixed(3));
      res[2] = parseFloat(res[2].toFixed(3));
      res[3] = parseFloat(res[3].toFixed(1));
  ...
  describe('parse oklab()', () => {
    ...
    it('should get value', () => {
      ...
      const val = mjs.rgbToXyz([0.48477, 0.3429, 0.38412, 1]);
      res[0] = parseFloat(res[0].toFixed(4));
      res[1] = parseFloat(res[1].toFixed(4));
      res[2] = parseFloat(res[2].toFixed(4));
      val[0] = parseFloat(val[0].toFixed(4));
    ...
    it('should get value', () => {
      ...
      const val = mjs.rgbToXyz([0.29264, 0.70096, 0.63017, 1]);
      res[0] = parseFloat(res[0].toFixed(5));
      res[1] = parseFloat(res[1].toFixed(5));
      res[2] = parseFloat(res[2].toFixed(5));
    ...
    it('should get value', () => {
      ...
      const val = mjs.rgbToXyz([0.73942, 0.60484, 0.1965, 1]);
      res[0] = parseFloat(res[0].toFixed(5));
      res[1] = parseFloat(res[1].toFixed(5));
      res[2] = parseFloat(res[2].toFixed(5));
      val[0] = parseFloat(val[0].toFixed(5));
    ...
    it('should get value', () => {
      ...
      const val = mjs.rgbToXyz([0.27888, 0.38072, 0.89414, 1]);
      res[0] = parseFloat(res[0].toFixed(5));
      res[1] = parseFloat(res[1].toFixed(5));
      res[2] = parseFloat(res[2].toFixed(5));
      val[0] = parseFloat(val[0].toFixed(5));
    ...
    it('should get value', () => {
      ...
      const val = mjs.hexToXyz('#7654cd80');
      res[0] = parseFloat(res[0].toFixed(4));
      res[1] = parseFloat(res[1].toFixed(4));
      res[2] = parseFloat(res[2].toFixed(4));
      res[3] = parseFloat(res[3].toFixed(2));
    ...
    it('should get value', () => {
      const res = func('oklab(0.54432 0.06817 -0.16567 / -50%)');
      const val = mjs.hexToXyz('#7654cd00');
      res[0] = parseFloat(res[0].toFixed(4));
      res[1] = parseFloat(res[1].toFixed(4));
      res[2] = parseFloat(res[2].toFixed(4));
      res[3] = parseFloat(res[3].toFixed(2));
    ...
    it('should get value', () => {
      ...
      const val = mjs.hexToXyz('#7654cdff');
      res[0] = parseFloat(res[0].toFixed(4));
      res[1] = parseFloat(res[1].toFixed(4));
      res[2] = parseFloat(res[2].toFixed(4));
      res[3] = parseFloat(res[3].toFixed(2));
  ...
  describe('parse oklch()', () => {
    ...
    it('should get value', () => {
      ...
      const hex = mjs.convertColorToHex('rgb(70.492% 2.351% 37.073%)');
      const val = mjs.hexToXyz(hex);
      res[0] = parseFloat(res[0].toFixed(2));
      res[1] = parseFloat(res[1].toFixed(2));
      res[2] = parseFloat(res[2].toFixed(2));
      val[0] = parseFloat(val[0].toFixed(2));
    ...
    it('should get value', () => {
      ...
      const hex = mjs.convertColorToHex('rgb(23.056% 31.73% 82.628%)');
      const val = mjs.hexToXyz(hex);
      res[0] = parseFloat(res[0].toFixed(1));
      res[1] = parseFloat(res[1].toFixed(3));
      res[2] = parseFloat(res[2].toFixed(2));
    ...
    it('should get value', () => {
      ...
      const hex = mjs.convertColorToHex('rgb(32.022% 85.805% 61.147%)');
      const val = mjs.hexToXyz(hex);
      res[0] = parseFloat(res[0].toFixed(2));
      res[1] = parseFloat(res[1].toFixed(2));
      res[2] = parseFloat(res[2].toFixed(3));
    ...
    it('should get value', () => {
      ...
      const hex = mjs.convertColorToHex('rgb(67.293% 27.791% 52.28%)');
      const val = mjs.hexToXyz(hex);
      res[0] = parseFloat(res[0].toFixed(1));
      res[1] = parseFloat(res[1].toFixed(2));
      res[2] = parseFloat(res[2].toFixed(2));
  ...
  describe('parse color func', () => {
    ...
    it('should get value', () => {
      ...
      const value = mjs.parseColor('rgb(0% 50% 0%)');
      assert.deepEqual(res, value, 'result');
    });

    it('should get value', () => {
      const res = func('color(srgb 0 0.5 0)', true);
      const value = mjs.parseColor('rgb(0% 50% 0%)', true);
      assert.deepEqual(res, value, 'result');
    });
  ...
  describe('convert color to hex color', () => {
    ...
    it('should get value', () => {
      const res = func('hsla(180,50%,50%,1)', {
        alpha: true
      });
      assert.strictEqual(res, '#40bfbf', 'result');
    });
    ...
    it('should get value', () => {
      const res = func('lch(44.36% 69.13 301.43 / 0.5)', {
        alpha: true
      });
      assert.deepEqual(res, '#7654cd80', 'result');
    });
  ...
  describe('convert color() to hex color', () => {
    ...
    it('should get value', () => {
      ...
      const val = mjs.convertColorToHex('lab(87.8185% -79.271 80.9946)');
      assert.strictEqual(res, val, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const val =
        mjs.convertColorToHex('lab(86.61399% -106.539 102.871)');
      assert.strictEqual(res, val, 'result');
    });

    it('should get value', () => {
      const res = func('color(display-p3 1 1 0.330897)');
      const val = mjs.convertColorToHex('yellow');
      assert.strictEqual(res, val, 'result');
    });

    it('should get value', () => {
      const res = func('color(display-p3 0.465377 0.532768 0.317713)');
      const val = mjs.convertColorToHex('lch(54% 35 118)');
      assert.strictEqual(res, val, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const val =
        mjs.convertColorToHex('lab(83.2141% -129.1072 87.1718)');
      assert.strictEqual(res, val, 'result');
    });
    ...
    it('should get value', () => {
      const res = func('color(prophoto-rgb 0 1 0)');
      const val =
        mjs.convertColorToHex('lab(87.5745% -186.6921 150.9905)');
      assert.strictEqual(res, val, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const val = mjs.convertColorToHex('lab(100.115% 9.06448 5.80177)');
      assert.strictEqual(res, val, 'result');
    });

    it('should get value', () => {
      const res = func('color(xyz 0 1 0)');
      const val = mjs.convertColorToHex('lab(99.6289% -354.58 146.707)');
      assert.strictEqual(res, val, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const val = mjs.convertColorToHex('lab(100% 6.1097 -13.2268)');
      assert.strictEqual(res, val, 'result');
    });
  ...
  describe('convert color-mix() to hex color', () => {
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('rgb(0, 64, 128)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      const res =
        func('color-mix(in srgb, rgb(0 0 255), rgb(0 128 0))');
      const value = mjs.convertColorToHex('rgb(0, 64, 128)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      const res =
        func('color-mix(in srgb, hwb(240 0% 0%), hwb(120 0% 50%))');
      const value = mjs.convertColorToHex('rgb(0, 64, 128)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('rgba(255, 0, 0, 0.6)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('rgb(230, 0, 26)');
      assert.strictEqual(res, value, 'result');
    });

    it('should get value', () => {
      const res = func('color-mix(in srgb, blue 100%, red)');
      const value = mjs.convertColorToHex('rgb(0, 0, 255)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('rgb(0, 0, 255, 0.5)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('rgb(53.846% 46.154% 0% / 0.325)', {
          alpha: true
        });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('rgb(53.846% 46.154% 0% / 0.26)', {
          alpha: true
        });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      const res = func('color-mix(in srgb-linear, red, rgba(0, 0, 255, 0.5) 100%)', {
        alpha: true
      });
      assert.strictEqual(res, '#00008980', 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('rgb(188, 92, 0)');
      assert.strictEqual(res, value, 'result');
    });

    it('should get value', () => {
      const res = func('color-mix(in xyz, red, green 90%)');
      const value = mjs.convertColorToHex('rgb(89, 122, 0)');
      assert.strictEqual(res, value, 'result');
    });

    it('should get value', () => {
      const res = func('color-mix(in xyz, red 90%, green)');
      const value = mjs.convertColorToHex('rgb(243, 40, 0)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('rgb(99, 45, 0, 0.5)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hsl(180 100% 37.6%)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hsl(180 100% 37.5%)');
      assert.strictEqual(res, value, 'result');
    });

    it('should get value', () => {
      const res =
        func('color-mix(in hsl, white, green)');
      const value = mjs.convertColorToHex('hsl(120 100% 62.549%)');
      assert.strictEqual(res, value, 'result');
    });

    it('should get value', () => {
      const res =
        func('color-mix(in hsl, hsl(120 10% 20%), hsl(30 30% 40%))');
      const value = mjs.convertColorToHex('hsl(75 20% 30%)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hsl(52.5 25% 35%)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hsl(97.5 15% 25%)');
      assert.strictEqual(res, value, 'result');
    });

    it('should get value', () => {
      const res = func('color-mix(in hsl, hsl(120 10% 20%) 25%, hsl(30 30% 40%) 75%)');
      const value = mjs.convertColorToHex('hsl(52.5 25% 35%)');
      assert.strictEqual(res, value, 'result');
    });

    it('should get value', () => {
      const res = func('color-mix(in hsl, hsl(120 10% 20%) 30%, hsl(30 30% 40%) 90%)');
      const value = mjs.convertColorToHex('hsl(52.5 25% 35%)');
      assert.strictEqual(res, value, 'result');
    });

    it('should get value', () => {
      const res = func('color-mix(in hsl, hsl(120 10% 20%) 12.5%, hsl(30 30% 40%) 37.5%)', {
        alpha: true
      });
      const value = mjs.convertColorToHex('hsl(52.5 25% 35% / 0.5)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      const res =
        func('color-mix(in hsl, hsl(120 10% 20%) 0%, hsl(30 30% 40%))');
      const value = mjs.convertColorToHex('hsl(30 30% 40%)');
      assert.strictEqual(res, value, 'result');
    });

    it('should get value', () => {
      const res = func('color-mix(in hsl, hsl(120 10% 20% / .4), hsl(30 30% 40% / .8))', {
        alpha: true
      });
      const value = mjs.convertColorToHex('rgba(95, 105, 65, 0.6)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      const res = func('color-mix(in hsl, hsl(120 10% 20%) 25%, hsl(30 30% 40% / .8))', {
        alpha: true
      });
      const value = mjs.convertColorToHex('rgba(108, 103, 66, 0.85)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('rgba(68, 84, 59, 0.5)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('rgba(120, 114, 69, 0.7)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('rgba(120, 114, 69, 0.35)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('rgba(133, 102, 71, 0.8)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hwb(180 0% 25%)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hwb(120 49.9% 24.9%)');
      assert.strictEqual(res, value, 'result');
    });

    it('should get value', () => {
      const res =
        func('color-mix(in hwb, hwb(0 100% 0%), hwb(0 0% 100%))');
      assert.strictEqual(res, '#7f7f7f', 'result');
    });

    it('should get value', () => {
      const res =
        func('color-mix(in hwb, hwb(120 10% 20%), hwb(30 30% 40%))');
      const value = mjs.convertColorToHex('hwb(75 20% 30%)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hwb(52.5 25% 35%)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hwb(97.5 15% 25%)');
      assert.strictEqual(res, value, 'result');
    });

    it('should get value', () => {
      const res = func('color-mix(in hwb, hwb(120 10% 20%) 25%, hwb(30 30% 40%) 75%)');
      const value = mjs.convertColorToHex('hwb(52.5 25% 35%)');
      assert.strictEqual(res, value, 'result');
    });

    it('should get value', () => {
      const res = func('color-mix(in hwb, hwb(120 10% 20%) 30%, hwb(30 30% 40%) 90%)');
      const value = mjs.convertColorToHex('hwb(52.5 25% 35%)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hwb(52.5 25% 35% / 0.5)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hwb(30 30% 40%)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hwb(75 23.33% 33.33% / 0.6)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('hwb(52.5 24.117647% 34.117647% / 0.85)', {
          alpha: true
        });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hwb(97.5 18% 28% / 0.5)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('hwb(52.5 27.14% 37.14% / 0.7)', {
          alpha: true
        });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('hwb(52.5 27.14% 37.14% / 0.35)', {
          alpha: true
        });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hwb(30 30% 40% / 0.8)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('lab(50.284 16.626 59.2386)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('lab(47.07899 -34.716675 50.71676)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('lab(53.489 67.969 67.7605)');
      assert.strictEqual(res, value, 'result');
    });

    it('should get value', () => {
      const res = func('color-mix(in lch, red, green)');
      const value = mjs.convertColorToHex('lch(50.28% 87.41 87.62)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('lch(47.08% 71.87 125.03)');
      assert.strictEqual(res, value, 'result');
    });

    it('should get value', () => {
      const res = func('color-mix(in lch, red 90%, green)');
      const value = mjs.convertColorToHex('lch(53.49 102.95 50.21)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('oklab(0.573853594 0.04228 0.116761 / 1)');
      assert.strictEqual(res, value, 'result');
    });

    it('should get value', () => {
      const res = func('color-mix(in oklab, color(srgb 1 0 0), color(srgb 0 0.5 0))');
      const value =
        mjs.convertColorToHex('oklab(0.573853594 0.04228 0.116761 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('oklab(0.53057 -0.104 0.10949 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('oklab(0.6171 0.1883 0.124 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('oklch(0.58 0.2187445576 84.3177 / 1)');
      assert.strictEqual(res, value, 'result');
    });

    it('should get value', () => {
      const res = func('color-mix(in oklch, color(srgb 1 0 0), color(srgb 0 0.5 0))');
      const value =
        mjs.convertColorToHex('oklch(0.5791 0.21874 84.3177 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('oklch(0.533387 0.18065 127.843 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('oklch(0.6264 0.2568 40.792 / 1)');
      assert.strictEqual(res, value, 'result');
    });

    it('should get value', () => {
      const res = func('color-mix(in srgb, color(srgb 0 0.5 0), color(srgb 1 0 1))');
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('rgb(134.5, 128, 121.5)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in srgb, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('rgb(77, 128, 121.5)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in srgb, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('rgb(192, 128, 121.5)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'color(srgb none 0.5 0.7 / 1)';
      const res = func(`color-mix(in srgb, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('rgb(0, 128, 121.5)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'color(srgb 0.3 0.5 0.7 / 1)';
      const res = func(`color-mix(in srgb, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('rgb(134.5, 127, 121.5)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'color(srgb 0.3 none 0.7 / 1)';
      const res = func(`color-mix(in srgb, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('rgb(134.5, 0, 121.5)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'color(srgb 0.3 0.5 0.7 / 1)';
      const res = func(`color-mix(in srgb, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('rgb(134.5, 128, 179)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in srgb, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('rgb(134.5, 128, 64)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'color(srgb 0.3 0.5 none / 1)';
      const res = func(`color-mix(in srgb, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('rgb(134.5, 128, 0)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('rgba(134.5, 127.5, 121.5, 0)', {
          alpha: true
        });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertLinearRgbToHex([
        0.30066434704298134,
        0.21586050011389923,
        0.2510276206061334,
        1
    ...
    it('should get value', () => {
      ...
      const colorB = 'color(srgb 0.3 0.5 0.7 / 1)';
      const res =
        func(`color-mix(in srgb-linear, ${colorA}, ${colorB})`, {
          alpha: true
        });
      const value = mjs.convertLinearRgbToHex([
        0.30066434704298134,
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertXyzToHex([
        0.24648520759776654,
        0.23643190167188327,
        0.2701513572532229,
        1
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertXyzD50ToHex([
        0.2501650544900184,
        0.2368606099644367,
        0.20440109934622114,
        1
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hsl(85.69 48.2% 30.5%)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hsl(51.38 86.6% 40.98%)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hsl(120 9.8% 20% / 1)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(70% 70 90 / 1)'; // hsl(51.38 86.6% 40.98%)
      const res = func(`color-mix(in hsl, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('hsl(51.3 48.1% 30.55%)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in hsl, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('hsl(120 54.9% 45.5%)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(70% 70 none / 1)';
      const res = func(`color-mix(in hsl, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('hsl(0 54.9% 45.5%)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(70% 70 90 / 1)'; // hsl(51.38 86.6% 40.98%)
      const res = func(`color-mix(in hsl, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('hsl(25.67 86.4% 30.6%)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in hsl, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('hsl(105.9 9.8% 43.5%)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(70% none 90 / 1)';
      const res = func(`color-mix(in hsl, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('hsl(0 0% 43.5%)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in hsl, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('hsl(60 54.9% 20%)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(none 70 90 / 1)';
      const res = func(`color-mix(in hsl, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('hsl(0 100% 0%)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('hsl(85.69 48.2% 30.5% / 0)', {
          alpha: true
        });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('hwb(85.6653 11.8% 50.7% / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in hwb, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('hwb(51.33 11.8% 50.7% / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(70% 70 none / 1)';
      const res = func(`color-mix(in hwb, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('hwb(120 29.9% 39.02% / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(70% 70 none / 1)';
      const res = func(`color-mix(in hwb, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('hwb(0 29.9% 39.02% / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hwb(85.665 11.8% 50.7% / 1)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hwb(85.665 11.8% 50.7% / 0)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in hwb, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('hwb(75 20% 30% / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'hwb(30 30% 40% / 1)';
      const res = func(`color-mix(in hwb, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('hwb(30 15% 70%)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'currentColor';
      const res = func(`color-mix(in hwb, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('hwb(120 5% 60% / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'hwb(30 30% 40% / 1)';
      const res = func(`color-mix(in hwb, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('hwb(75 15% 30% / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in hwb, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('hwb(75 5% 30% / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'hwb(30  none 40% / 1)';
      const res = func(`color-mix(in hwb, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('hwb(75 0% 30% / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('hwb(75 20% 20% / 1)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in hwb, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('hwb(75 20% 10.1% / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'hwb(30 30% none / 1)';
      const res = func(`color-mix(in hwb, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('hwb(75 20% 0% / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in hwb, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('hwb(30 40% 45% / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('lab(46.166 -3.0737 37.40635 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in lab, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('lab(70 0 70 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in lab, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('lab(22.332 -6.1474695 4.8127 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in lab, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('lab(22.332 -6.147469558 4.8127 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(none 70 90 / 1)';
      const res = func(`color-mix(in lab, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('lab(0 0 0 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('lab(46.166 -3.0737 37.406 / 1)', {
          alpha: true
        });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('lab(46.166 -3.0737 37.406 / 0)', {
          alpha: true
        });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'white';
      const res = func(`color-mix(in lab, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('lab(50% 0% 0% / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'white';
      const res = func(`color-mix(in lab, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('lab(75 31.4 47.1 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('lch(46.12 38.88 116 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(70% 70 90 / 1)';
      const res = func(`color-mix(in lch, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('lch(70 70 90 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'currentColor';
      const res = func(`color-mix(in lch, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('lch(22.332 7.8 141.94 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(none 70 90 / 1)';
      const res = func(`color-mix(in lch, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('lch(22.332 7.807 141.94 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(none 70 90 / 1)';
      const res = func(`color-mix(in lch, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('lch(0 0 0 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in lch, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('lch(45.574795 69.945 90.052 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(70% none 90 / 1)';
      const res = func(`color-mix(in lch, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('lch(46.157 7.8 141.94 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(70% none 90 / 1)';
      const res = func(`color-mix(in lch, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('lch(45.6 0 0 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(70% 70 90 / 1)';
      const res = func(`color-mix(in lch, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('lch(45 37.5 90.1 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(70% 70 none / 1)';
      const res = func(`color-mix(in lch, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('lch(46.166 38.9 141.94 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(70% 70 none / 1)';
      const res = func(`color-mix(in lch, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('lch(45.03 37.51 0 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value = mjs.convertColorToHex('lch(46.12 38.88 116 / 0)', {
        alpha: true
      });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('oklab(0.532 -0.01913 0.080463 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in oklab, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('oklab(0.736 -0.0202 0.1483344 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in oklab, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('oklab(0 -0.018 0.012592 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in oklab, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('oklab(0.736 -0.020 0.1483344 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in oklab, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('oklab(0.328 -0.018 0.012592 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(none 70 90 / 1)';
      const res = func(`color-mix(in oklab, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('oklab(0 0 0 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in oklab, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('oklab(0.5287 -0.01012 0.074 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in oklab, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('oklab(0.534687 -0.009 0.006296 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(70% none 90 / 1)';
      const res = func(`color-mix(in oklab, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('oklab(0.5312 0 0 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in oklab, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('oklab(0.524 -0.003165 0.0764 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in oklab, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('oklab(0.5464 0.0987 0.00504696 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in oklab, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('oklab(0.5385 0.114672 0.001 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('oklab(0.532 -0.0191 0.080463 / 1)', {
          alpha: true
        });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('oklab(0.532 -0.0191 0.080463 / 0)', {
          alpha: true
        });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'black';
      const res = func(`color-mix(in oklab, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('oklab(0.498396 0 0)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in oklab, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('oklab(0.78766 0.07926686 0.10096213 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('oklch(0.5353 0.093 105.5239 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in oklch, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('oklch(0.74212 0.15659 92.136789 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in oklch, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('oklch(0.3285 0.02946 118.911 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in oklch, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('oklch(0.742124 0.15659 92.13679 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(none 70 90 / 1)';
      const res = func(`color-mix(in oklch, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('oklch(0 0 0 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in oklch, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('oklch(0.53176 0.15659 84.720389 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in oklch, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('oklch(0.5353 0.02946 98.10749 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const colorB = 'lch(70% none 90 / 1)';
      const res = func(`color-mix(in oklch, ${colorA}, ${colorB})`);
      const value = mjs.convertColorToHex('oklch(0.531748 0 0 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in oklch, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('oklch(0.5275 0.09076 92.13679 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in oklch, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('oklch(0.54915 0.1256 118.911 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const res = func(`color-mix(in oklch, ${colorA}, ${colorB})`);
      const value =
        mjs.convertColorToHex('oklch(0.54135 0.12337 0 / 1)');
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('oklch(0.5353 0.093029 105.5239 / 1)', {
          alpha: true
        });
      assert.strictEqual(res, value, 'result');
    });
    ...
    it('should get value', () => {
      ...
      const value =
        mjs.convertColorToHex('oklch(0.5353 0.093029 105.5239 / 0)', {
          alpha: true
        });
      assert.strictEqual(res, value, 'result');
    });
